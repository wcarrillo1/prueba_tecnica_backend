...
namespace prueba_back_end.Controllers
{
    ...
    public class PersonaController : ControllerBase
    {
        ...
        [Route("store")]
        //[Authorize]
        public IActionResult Store(PersonaModel request)
        {
            Responses result;
            ...
            using (SqlConnection conn = new SqlConnection(_connectionString))
            {
                ...
                using (SqlCommand cmd = new SqlCommand(_nameProcedure, conn))
                {
                    ...
                    resultado.message = "Persona agregado con éxito.";
                    resultado.value = 1;
        ...
        public IActionResult Update(PersonaModel request)
        {
            ...
            using (SqlConnection conn = new SqlConnection(_connectionString))
            {
                ...
                using (SqlCommand cmd = new SqlCommand(_nameProcedure, conn))
                {
                    ...
                    dynamic resultado = new JObject();
                    resultado.response = 1;
                    resultado.message = "Persona actualizado con éxito.";
                    resultado.value = 1;
