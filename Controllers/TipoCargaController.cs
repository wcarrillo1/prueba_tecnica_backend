...
namespace prueba_back_end.Controllers
{
    ...
    public class TipoCargaController : ControllerBase
    {
        ...
        public TipoCargaController(IConfiguration _configuration)
        {
            Configuration = _configuration;
            _connectionString = Configuration.GetConnectionString("MainConnection");
            _nameProcedure = "crudTipoCarga";
        }
        ...
        [Route("store")]
        //[Authorize]
        public IActionResult Store(TipoCargaModel request)
        {
            Responses result;
            ...
            using (SqlConnection conn = new SqlConnection(_connectionString))
            {
                ...
                using (SqlCommand cmd = new SqlCommand(_nameProcedure, conn))
                {
                    ...
                    resultado.message = "Tipo De Carga agregado con éxito.";
                    resultado.value = 1;
        ...
        [Route("update")]
        //[Authorize]
        public IActionResult Update(DepartamentoModel request)
        {
            Responses result;
            ...
            using (SqlConnection conn = new SqlConnection(_connectionString))
            {
                ...
                using (SqlCommand cmd = new SqlCommand(_nameProcedure, conn))
                {
                    ...
                    dynamic resultado = new JObject();
                    resultado.response = 1;
                    resultado.message = "Tipo de Carga actualizado con éxito.";
                    resultado.value = 1;
