...
namespace prueba_back_end.Controllers
{
    ...
    public class TipoPersonaController : ControllerBase
    {
        ...
        public TipoPersonaController(IConfiguration _configuration)
        {
            Configuration = _configuration;
            _connectionString = Configuration.GetConnectionString("MainConnection");
            _nameProcedure = "crudTipoPersona";
        }
        ...
        [Route("store")]
        //[Authorize]
        public IActionResult Store(TipoPersonaModel request)
        {
            Responses result;
            ...
            using (SqlConnection conn = new SqlConnection(_connectionString))
            {
                ...
                using (SqlCommand cmd = new SqlCommand(_nameProcedure, conn))
                {
                    ...
                    resultado.message = "Tipo De Persona agregado con éxito.";
                    resultado.value = 1;
        ...
        [Route("update")]
        //[Authorize]
        public IActionResult Update(TipoPersonaModel request)
        {
            Responses result;
            ...
            using (SqlConnection conn = new SqlConnection(_connectionString))
            {
                ...
                using (SqlCommand cmd = new SqlCommand(_nameProcedure, conn))
                {
                    ...
                    dynamic resultado = new JObject();
                    resultado.response = 1;
                    resultado.message = "Tipo de Persona actualizado con éxito.";
                    resultado.value = 1;
        ...
        public IActionResult Destroy(JObject request)
        {
            ...
            using (SqlConnection conn = new SqlConnection(_connectionString))
            {
                ...
                using (SqlCommand cmd = new SqlCommand(_nameProcedure, conn))
                {
                    ...
                    dynamic resultado = new JObject();
                    resultado.response = 1;
                    resultado.message = "Se ha dado de baja con éxito.";
                    resultado.value = 1;
        ...
        public IActionResult Active(JObject request)
        {
            ...
            using (SqlConnection conn = new SqlConnection(_connectionString))
            {
                ...
                using (SqlCommand cmd = new SqlCommand(_nameProcedure, conn))
                {
                    ...
                    dynamic resultado = new JObject();
                    resultado.response = 1;
                    resultado.message = "Se ha dado de alta con éxito.";
                    resultado.value = 1;
